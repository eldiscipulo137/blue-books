...
<p><Pin lang="es">18</Pin> El Dr. W. B. PilIsbury cree que este doble sistema implica una duplicación innecesaria:</p>

> Si aceptamos la teoría conductista, significa que debemos tener dos psicologías, una externa y otra interna; una psicología observada desde lo exterior y otra desde lo interior. Esto parece, en el mejor de los casos, una complicación innecesaria [^2]
...
Dice el Dr. Hermann Rubin [^11] que "la apariencia física del individuo, sus rasgos síquicos, o lo que pudiera llamarse la química de su alma, se demuestran <Pin lang="en">22</Pin> en gran parte por el carácter y la cantidad de secreciones internas de sus diversas glándulas".
