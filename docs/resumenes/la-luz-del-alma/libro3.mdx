...
1. **Iluminación de la percepción.** La luz del alma fluye y el hombre en el plano físico, en su conciencia cerebral, puede percibir lo que antes estaba oscuro y oculto. Podemos describir técnicamente el proceso en los concisos términos siguientes:
   ...
   5. La luz de la cabeza se acrecienta en la correspondiente medida, y el tercer ojo se desarrolla y funciona, como también el correspondiente <Pin lang="en">254</Pin> "ojo" en los planos astral y mental; de esta manera el ego o alma puede iluminar los tres planos en los tres mundos, lo mismo que el reino del alma. <Pin lang="es">165</Pin>
...
1. Luego el yogui repentinamente se desliza fuera del estado <Pin lang="es">169</Pin> inferior de conciencia, y se da cuenta que está identificado con el perceptor, con el pensador en su propio plano, y debido a que la mente está controlada y el <Pin lang="en">261</Pin> objeto visto no evoca respuesta, la verdadera identidad puede percibir lo que hasta entonces ha estado velado.
